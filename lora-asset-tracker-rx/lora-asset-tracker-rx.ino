...
//latitude,longtitude,altitude,sattelite,speed,bearing,voltage,temp,pressure,etc. / 13 packets
typedef union {
...
if (readBatt() > battMin) {
  ...
  if(receivedFlag) {
    ...
    int state = radio.readData(byteArr, sizeof(telemetry));
...
switch(pageID) {
  case 1:
    ...
    display.print("SNR      :");display.print(radio.getSNR()); display.println(" dB");
    display.print("PcktLngth:");display.print(radio.getPacketLength()); display.println(" bytes");               
    break;
  case 2:
  ...
  case 3:
    ...
    break;
  case 4:
    display.println("RX Alt Data (3/3)");
    display.println("");        
    display.print("Min Press:");display.print(telemetry.f[10]);display.println("hPa");
    display.print("Max Alt:");display.print(telemetry.f[9]);display.println(altUnit);                
    break;
  case 5:
...
void printRXTelemetry() {
  ...
  SerialUSB.println((int)telemetry.f[11]);
  SerialUSB.print(F("trackerID :"));  
  SerialUSB.println((int)telemetry.f[12]);
