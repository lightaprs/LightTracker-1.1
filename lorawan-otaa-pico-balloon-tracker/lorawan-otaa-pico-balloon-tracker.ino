...
boolean gpsHP303BSetup=false; //do not change this.
//********************************* Power Settings ******************************
...
void printGPSandSensorData()
{
    ...
    SerialUSB.print(readPressure() / 100.0);
    SerialUSB.print(" hPa");
...
void updateTelemetry() {
  ...
  if(measurementSystem == 0){ //Metric
    ...
    tempTemperature = readTemperature(); //Celsius   
    ...
    tempTemperature =  (readTemperature() * 1.8f) + 32; //Fahrenheit      
  }    
  ...
  telemetry.addBarometricPressure(7, readPressure() / 100.f); //pressure  
